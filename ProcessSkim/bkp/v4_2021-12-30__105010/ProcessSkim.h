...
class ProcessSkim : public TSelector {
   ...
   TH2D *h2_CTagEff_Denom_b ; 
   TH2D *h2_CTagEff_Denom_c ; 
   TH2D *h2_CTagEff_Denom_udsg ; 
   //Loose CTag efficiency 2D histos          
   TH2D *h2_CTagEff_Num_bL ; 
   TH2D *h2_CTagEff_Num_cL ; 
   TH2D *h2_CTagEff_Num_udsgL ; 
   //Medium CTag efficiency 2D histos          
   TH2D *h2_CTagEff_Num_bM ; 
   TH2D *h2_CTagEff_Num_cM ; 
   TH2D *h2_CTagEff_Num_udsgM ; 
   //Tight CTag efficiency 2D histos          
   TH2D *h2_CTagEff_Num_bT ; 
   TH2D *h2_CTagEff_Num_cT ; 
   TH2D *h2_CTagEff_Num_udsgT ; 
   ////////////////////////////////////////////////////////
