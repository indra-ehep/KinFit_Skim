...
#inputdir="/eos/user/i/idas/Output/cms-hcs-run2/CBA_gdjsoncorr"
#inputdir="/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_gdjsoncorr-BJetHist1"
inputdir="/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_gdjsoncorr-Hist1"
#inputdir="/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_ctagv2-Hist1"
#/eos/user/i/idas/Output/cms-hcs-run2/CBA_gdjsoncorr
#inputdir="/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_muFmuRFSRDo-Hist1"
