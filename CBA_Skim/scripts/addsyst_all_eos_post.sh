...
#inputdir="/eos/user/i/idas/Output/cms-hcs-run2/CBA_metxycorr/post"
...
inputdir="/eos/user/i/imirza/idas/Output/cms-hcs-run2/Result/CBA_metxycorr-BJetHist1/post"
...
#inputdir="/eos/user/i/imirza/idas/Output/cms-hcs-run2/Result/CBA_metxycorr-Hist1/post"
...
do
	...
	do
		...
		do
			...
			echo "Arguments  = $year ${sample} input/eos/$year/post/${sample}_${year}.txt $ifindex $syst" >> /tmp/$USER/missing_${year}_post.txt
