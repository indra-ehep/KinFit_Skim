...
int QCDDDAll(bool isBtag, bool isMu, int htype, int year, TDirectory *d3, const char* dir, const char *systType, TH1D *hDD)
{
  ...
  fin_nano_ttw->Close();     fin_nano_ttz->Close();     fin_nano_ttg->Close();    fin_nano_tth->Close();
  ...
  delete fin_nano_ttw;     delete fin_nano_ttz;     delete fin_nano_ttg;    delete fin_nano_tth;
