...
int BTagSF()
{
  ...
  for(int ip=0;ip<npoints;ip++){
    pt += 1.0;
    SF = readera.eval_auto_bounds("central", BTagEntry::FLAV_B, 2.0, pt);
    // SF_up = readera.eval_auto_bounds("up", BTagEntry::FLAV_B, 2.0, pt);
    // SF_down = readera.eval_auto_bounds("down", BTagEntry::FLAV_B, 2.0, pt);
    SF_up = readera.eval_auto_bounds("central", BTagEntry::FLAV_C, 2.0, pt);
    SF_down = readera.eval_auto_bounds("central", BTagEntry::FLAV_UDSG, 2.0, pt);
    gr1->SetPoint(ip+1, pt , SF);
    gr2->SetPoint(ip+1, pt , SF_up);
    gr3->SetPoint(ip+1, pt , SF_down);

    SF = readerb.eval_auto_bounds("central", BTagEntry::FLAV_B, 2.0, pt);
    SF_up = readerb.eval_auto_bounds("central", BTagEntry::FLAV_C, 2.0, pt);
    SF_down = readerb.eval_auto_bounds("central", BTagEntry::FLAV_UDSG, 2.0, pt);
