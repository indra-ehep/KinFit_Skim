...
#---------------------------------------------
condorOutDir=/eos/user/s/savarghe/Indra_Da/Output/cms-hcs-run2/CBA_HLTemul
condorOutDir1=/eos/user/i/idas/Output/cms-hcs-run2/CBA_HLTemul
condorOutDir2=/cms/store/user/idas/Output/cms-hcs-run2/KinTreeUL/CBA_HLTemul
condorOutDir3=/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_HLTemul
condorOutDir4=/eos/user/a/anayak/HplusAnalysisRun2/idas/Output/cms-hcs-run2/CBA_HLTemul
# condorOutDir=/eos/user/s/savarghe/Indra_Da/Output/cms-hcs-run2/CBA_HLTemul/post
# condorOutDir1=/eos/user/i/idas/Output/cms-hcs-run2/CBA_HLTemul/post
# condorOutDir2=/cms/store/user/idas/Output/cms-hcs-run2/KinTreeUL/CBA_HLTemul/post
# condorOutDir3=/eos/user/d/dugad/idas/Output/cms-hcs-run2/CBA_HLTemul/post
# condorOutDir4=/eos/user/a/anayak/HplusAnalysisRun2/idas/Output/cms-hcs-run2/CBA_HLTemul/post
