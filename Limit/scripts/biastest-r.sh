...
testdir=$PWD/local/${ch}_${year}_x200_t${ntoys}_test_unbound_qcdrate-r/Cat1_Inc/Mass$mass
...
combine datacard_SR_MR_WH${mass}.root -M FitDiagnostics --setParameters $app -m $mass --redefineSignalPOIs BR --rMin -2.0 --rMax 2.0  --cminDefaultMinimizerStrategy 0 --robustFit 1 -n _SRMR
echo "==== END OF STEP1 ========"
...
combine morphedWorkspace.root -M FitDiagnostics  --toysFile higgsCombine_SRMR_0.GenerateOnly.mH${mass}.123456.root -t $ntoys --toysFrequentist -m $mass --redefineSignalPOIs BR --rMin -2.0 --rMax 2.0 --cminDefaultMinimizerStrategy 0 --robustFit 1 -n BR_0
...
do
    ...
    combine morphedWorkspace.root -M FitDiagnostics  --toysFile higgsCombine_SRMR_${sigma}.GenerateOnly.mH${mass}.123456.root -t $ntoys --toysFrequentist -m $mass --redefineSignalPOIs BR  --rMin -2.0 --rMax 2.0 --cminDefaultMinimizerStrategy 0 --robustFit 1 -n BR_${sigma}
...
# Step 3 "Input the toys" + "Signal injection tests"
combine morphedWorkspace.root -M FitDiagnostics  --toysFile higgsCombine_SRMR_1.GenerateOnly.mH${mass}.123456.root -t $ntoys --toysFrequentist -m $mass --redefineSignalPOIs BR --rMin -2.0 --rMax 2.0  --cminDefaultMinimizerStrategy 0 --robustFit 1 -n BR_1
