...
# indir_SR_base=$PWD/TIFRAPAR-2023-01-15/44_trigSF_impacts_bld_excLMT/2016/Comb/${ch}/Cat1_Inc/Mass$mass
# indir_MR_base=$PWD/TIFRAPAR-2023-01-15/47_trigSF_unbld_exc0_stat/2016/Comb/${ch}/Cat1_Inc/Mass$mass

# indir_SR_base=$PWD/TIFRAPAR-2023-01-15/44_trigSF_impacts_bld_excLMT/2016/Comb/${ch}/Cat1_Inc/Mass$mass
# indir_MR_base=$PWD/TIFRAPAR-2023-01-15/48_trigSF_unbld_exc0x200_stat/2016/Comb/${ch}/Cat1_Inc/Mass$mass

# indir_SR_base=$PWD/TIFRAPAR-2023-01-15/44_trigSF_impacts_bld_excLMT/2016/Comb/${ch}/Cat1_Inc/Mass$mass
# indir_MR_base=$PWD/TIFRAPAR-2023-01-15/49_trigSF_unbld_exc0x2E5_stat/2016/Comb/${ch}/Cat1_Inc/Mass$mass

indir_SR_base=$PWD/TIFRAPAR-2023-01-15/44_trigSF_impacts_bld_excLMT/Run2/Comb/${ch}/Cat1_Inc/Mass$mass
indir_MR_base=$PWD/TIFRAPAR-2023-01-15/49_trigSF_unbld_exc0x2E5_stat/Run2/Comb/${ch}/Cat1_Inc/Mass$mass
...
grep autoMCStats datacard_SR_MR_WH80.txt | grep signal | awk '{print $1}' > /tmp/fl.txt
unset array ; declare -a array ; nof_line=0 ; while read ifile ; do array[$nof_line]=mask_${ifile}=1 ; nof_line=$[$nof_line+1] ; done < /tmp/fl.txt ; echo Args are : ${array[@]}
...
combine morphedWorkspace.root -M FitDiagnostics  --toysFile higgsCombine_SRMR_0.GenerateOnly.mH${mass}.123456.root -t $ntoys -m $mass --redefineSignalPOIs BR --setParameterRanges BR=-2.0,2.0 --setParameters BR=0.0  --cminDefaultMinimizerStrategy 0 --robustFit 1 -n BR_0
...
do
    ...
    combine morphedWorkspace.root -M FitDiagnostics  --toysFile higgsCombine_SRMR_${sigma}.GenerateOnly.mH${mass}.123456.root -t $ntoys -m $mass --redefineSignalPOIs BR --setParameterRanges BR=-2.0,2.0 --setParameters BR=$brval --cminDefaultMinimizerStrategy 0 --robustFit 1 -n BR_${sigma}
done < $outfile
