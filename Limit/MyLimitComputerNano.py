...
def makeDataCards(IN_FILE_DIR, HIST_DIR, HIST_NAME, CHANNEL_NAME, SIG_MASS, SIG_LABEL, SIG_FILE):
    execme('root -l -q -b \"MyHPlusDataCardMakerNanoC.C+(\\\"'+IN_FILE_DIR+'\\\", \\\"'+HIST_DIR+'\\\",\\\"'+HIST_NAME+'\\\",\\\"'+CHANNEL_NAME+'\\\",'+str(SIG_MASS)+', \\\"'+SIG_LABEL+'\\\", \\\"'+SIG_FILE+'\\\")\"')
...
# 			      TString sigFile="all_HplusM080.root")
    ...
    #hist_array_Inc.append(["", "_lb_pt_mu"])
    #hist_array_Inc.append(["", "_kb_pt_mu_jets"])
