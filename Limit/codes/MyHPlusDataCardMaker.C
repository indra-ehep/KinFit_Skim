...
void MyHPlusDataCardMakerNano(TString inFileDir="stack_20180418_Mu_Sys_PreAppComent",
  ...
  TH1F* ttbar_bcstatUp = DC.readWriteHisto(fTT, baseDir+"/bcstatup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcstatUp", true, true, ttbar);
  TH1F* ttbar_bcstatDown = DC.readWriteHisto(fTT, baseDir+"/bcstatdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcstatDown", true, true, ttbar);
  ...
  if(year==2016 or year==2018){
    ttbar_bcxdyUp = DC.readWriteHisto(fTT, baseDir+"/bcxdyup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdyUp", true, true, ttbar);
    ttbar_bcxdyDown = DC.readWriteHisto(fTT, baseDir+"/bcxdydown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdyDown", true, true, ttbar);
    ttbar_bcxstUp = DC.readWriteHisto(fTT, baseDir+"/bcxstup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxstUp", true, true, ttbar);
    ttbar_bcxstDown = DC.readWriteHisto(fTT, baseDir+"/bcxstdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxstDown", true, true, ttbar);
    ttbar_bcxwjUp = DC.readWriteHisto(fTT, baseDir+"/bcxwjup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxwjUp", true, true, ttbar);
    ttbar_bcxwjDown = DC.readWriteHisto(fTT, baseDir+"/bcxwjdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxwjDown", true, true, ttbar);
    ttbar_bcxttUp = DC.readWriteHisto(fTT, baseDir+"/bcxttup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxttUp", true, true, ttbar);
    ttbar_bcxttDown = DC.readWriteHisto(fTT, baseDir+"/bcxttdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxttDown", true, true, ttbar);
  }else{
    ttbar_bcxdyUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdyUp", true);
    ttbar_bcxdyDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdyDown", true);
    ttbar_bcxstUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxstUp", true);
    ttbar_bcxstDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxstDown", true);
    ttbar_bcxwjUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxwjUp", true);
    ttbar_bcxwjDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxwjDown", true);
    ttbar_bcxttUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxttUp", true);
  ...
  if(year==2016){
    ttbar_bcbfragUp = DC.readWriteHisto(fTT, baseDir+"/bcbfragup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcbfragUp", true, true, ttbar);
    ttbar_bcbfragDown = DC.readWriteHisto(fTT, baseDir+"/bcbfragdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcbfragDown", true, true, ttbar);
  }else{
    ttbar_bcbfragUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcbfragUp", true);
  ...
  if(year==2017){ 
    ttbar_bcintpUp = DC.readWriteHisto(fTT, baseDir+"/bcintpup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcintpUp", true, true, ttbar);
    ttbar_bcintpDown = DC.readWriteHisto(fTT, baseDir+"/bcintpdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcintpDown", true, true, ttbar);
    ttbar_bcextpUp = DC.readWriteHisto(fTT, baseDir+"/bcextpup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcextpUp", true, true, ttbar);
    ttbar_bcextpDown = DC.readWriteHisto(fTT, baseDir+"/bcextpdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcextpDown", true, true, ttbar);
    ttbar_bcxdybUp = DC.readWriteHisto(fTT, baseDir+"/bcxdybup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdybUp", true, true, ttbar);
    ttbar_bcxdybDown = DC.readWriteHisto(fTT, baseDir+"/bcxdybdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdybDown", true, true, ttbar);
    ttbar_bcxdycUp = DC.readWriteHisto(fTT, baseDir+"/bcxdycup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdycUp", true, true, ttbar);
    ttbar_bcxdycDown = DC.readWriteHisto(fTT, baseDir+"/bcxdycdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxdycDown", true, true, ttbar);
    ttbar_bcxwjcUp = DC.readWriteHisto(fTT, baseDir+"/bcxwjcup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxwjcUp", true, true, ttbar);
    ttbar_bcxwjcDown = DC.readWriteHisto(fTT, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bcxwjcDown", true, true, ttbar);
  }else{
    ttbar_bcintpUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcintpUp", true);
    ttbar_bcintpDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcintpDown", true);
    ttbar_bcextpUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcextpUp", true);
    ttbar_bcextpDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcextpDown", true);
    ttbar_bcxdybUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdybUp", true);
    ttbar_bcxdybDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdybDown", true);
    ttbar_bcxdycUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdycUp", true);
    ttbar_bcxdycDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxdycDown", true);
    ttbar_bcxwjcUp = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxwjcUp", true);
    ttbar_bcxwjcDown = DC.readWriteHisto(fTT, baseDir+"/base"+histSubDir, histName, sf_ttbar, fout, fTT,  "ttbar_bcxwjcDown", true);
  }
  ...
  TH1F* ttbar_bclhemufUp = DC.readWriteHisto(fTT, baseDir+"/bclhemufup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bclhemufUp", true, true, ttbar);
  TH1F* ttbar_bclhemufDown = DC.readWriteHisto(fTT, baseDir+"/bclhemufdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bclhemufDown", true, true, ttbar);
  TH1F* ttbar_bclhemurUp = DC.readWriteHisto(fTT, baseDir+"/bclhemurup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bclhemurUp", true, true, ttbar);
  TH1F* ttbar_bclhemurDown = DC.readWriteHisto(fTT, baseDir+"/bclhemurdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_bclhemurDown", true, true, ttbar);
  TH1F* ttbar_isrUp = DC.readWriteHisto(fTT, baseDir+"/isrup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_isrUp", true, true, ttbar);
  TH1F* ttbar_isrDown = DC.readWriteHisto(fTT, baseDir+"/isrdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_isrDown", true, true, ttbar);
  TH1F* ttbar_fsrUp = DC.readWriteHisto(fTT, baseDir+"/fsrup"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_fsrUp", true, true, ttbar);
  TH1F* ttbar_fsrDown = DC.readWriteHisto(fTT, baseDir+"/fsrdown"+histSubDir, histName, sf_ttbar, fout, fTT, "ttbar_fsrDown", true, true, ttbar);
  ...
  TH1F* wjet_bcstatUp = DC.readWriteHisto(fWJ, baseDir+"/bcstatup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcstatUp", true, true, wjet);
  TH1F* wjet_bcstatDown = DC.readWriteHisto(fWJ, baseDir+"/bcstatdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcstatDown", true, true, wjet);
  TH1F *wjet_bcxdyUp, *wjet_bcxdyDown, *wjet_bcxstUp, *wjet_bcxstDown, *wjet_bcxwjUp, *wjet_bcxwjDown, *wjet_bcxttUp, *wjet_bcxttDown;
  if(year==2016 or year==2018){
    wjet_bcxdyUp = DC.readWriteHisto(fWJ, baseDir+"/bcxdyup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdyUp", true, true, wjet);
    wjet_bcxdyDown = DC.readWriteHisto(fWJ, baseDir+"/bcxdydown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdyDown", true, true, wjet);
    wjet_bcxstUp = DC.readWriteHisto(fWJ, baseDir+"/bcxstup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxstUp", true, true, wjet);
    wjet_bcxstDown = DC.readWriteHisto(fWJ, baseDir+"/bcxstdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxstDown", true, true, wjet);
    wjet_bcxwjUp = DC.readWriteHisto(fWJ, baseDir+"/bcxwjup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxwjUp", true, true, wjet);
    wjet_bcxwjDown = DC.readWriteHisto(fWJ, baseDir+"/bcxwjdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxwjDown", true, true, wjet);
    wjet_bcxttUp = DC.readWriteHisto(fWJ, baseDir+"/bcxttup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxttUp", true, true, wjet);
    wjet_bcxttDown = DC.readWriteHisto(fWJ, baseDir+"/bcxttdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxttDown", true, true, wjet);
  }else{
    wjet_bcxdyUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdyUp", true);
    wjet_bcxdyDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdyDown", true);
    wjet_bcxstUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxstUp", true);
    wjet_bcxstDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxstDown", true);
    wjet_bcxwjUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxwjUp", true);
    wjet_bcxwjDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxwjDown", true);
    wjet_bcxttUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxttUp", true);
  ...
  if(year==2016){
    wjet_bcbfragUp = DC.readWriteHisto(fWJ, baseDir+"/bcbfragup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcbfragUp", true, true, wjet);
    wjet_bcbfragDown = DC.readWriteHisto(fWJ, baseDir+"/bcbfragdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcbfragDown", true, true, wjet);
  }else{
    wjet_bcbfragUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcbfragUp", true);
  ...
  if(year==2017){
    wjet_bcintpUp = DC.readWriteHisto(fWJ, baseDir+"/bcintpup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcintpUp", true, true, wjet);
    wjet_bcintpDown = DC.readWriteHisto(fWJ, baseDir+"/bcintpdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcintpDown", true, true, wjet);
    wjet_bcextpUp = DC.readWriteHisto(fWJ, baseDir+"/bcextpup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcextpUp", true, true, wjet);
    wjet_bcextpDown = DC.readWriteHisto(fWJ, baseDir+"/bcextpdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcextpDown", true, true, wjet);
    wjet_bcxdybUp = DC.readWriteHisto(fWJ, baseDir+"/bcxdybup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdybUp", true, true, wjet);
    wjet_bcxdybDown = DC.readWriteHisto(fWJ, baseDir+"/bcxdybdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdybDown", true, true, wjet);
    wjet_bcxdycUp = DC.readWriteHisto(fWJ, baseDir+"/bcxdycup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdycUp", true, true, wjet);
    wjet_bcxdycDown = DC.readWriteHisto(fWJ, baseDir+"/bcxdycdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxdycDown", true, true, wjet);
    wjet_bcxwjcUp = DC.readWriteHisto(fWJ, baseDir+"/bcxwjcup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxwjcUp", true, true, wjet);
    wjet_bcxwjcDown = DC.readWriteHisto(fWJ, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bcxwjcDown", true, true, wjet);
  }else{
    wjet_bcintpUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcintpUp", true);
    wjet_bcintpDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcintpDown", true);
    wjet_bcextpUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcextpUp", true);
    wjet_bcextpDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcextpDown", true);
    wjet_bcxdybUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdybUp", true);
    wjet_bcxdybDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdybDown", true);
    wjet_bcxdycUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdycUp", true);
    wjet_bcxdycDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxdycDown", true);
    wjet_bcxwjcUp = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxwjcUp", true);
    wjet_bcxwjcDown = DC.readWriteHisto(fWJ, baseDir+"/base"+histSubDir, histName, sf_wjet, fout, fTT,  "wjet_bcxwjcDown", true);
  }
  ...
  TH1F* wjet_bclhemufUp = DC.readWriteHisto(fWJ, baseDir+"/bclhemufup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bclhemufUp", true, true, wjet);
  TH1F* wjet_bclhemufDown = DC.readWriteHisto(fWJ, baseDir+"/bclhemufdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bclhemufDown", true, true, wjet);
  TH1F* wjet_bclhemurUp = DC.readWriteHisto(fWJ, baseDir+"/bclhemurup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bclhemurUp", true, true, wjet);
  TH1F* wjet_bclhemurDown = DC.readWriteHisto(fWJ, baseDir+"/bclhemurdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_bclhemurDown", true, true, wjet);
  TH1F* wjet_isrUp = DC.readWriteHisto(fWJ, baseDir+"/isrup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_isrUp", true, true, wjet);
  TH1F* wjet_isrDown = DC.readWriteHisto(fWJ, baseDir+"/isrdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_isrDown", true, true, wjet);
  TH1F* wjet_fsrUp = DC.readWriteHisto(fWJ, baseDir+"/fsrup"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_fsrUp", true, true, wjet);
  TH1F* wjet_fsrDown = DC.readWriteHisto(fWJ, baseDir+"/fsrdown"+histSubDir, histName, sf_wjet, fout, fTT, "wjet_fsrDown", true, true, wjet);
  ...
  TH1F* zjet_bcstatUp = DC.readWriteHisto(fDY, baseDir+"/bcstatup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcstatUp", true, true, zjet);
  TH1F* zjet_bcstatDown = DC.readWriteHisto(fDY, baseDir+"/bcstatdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcstatDown", true, true, zjet);
  TH1F *zjet_bcxdyUp, *zjet_bcxdyDown, *zjet_bcxstUp, *zjet_bcxstDown, *zjet_bcxwjUp, *zjet_bcxwjDown, *zjet_bcxttUp, *zjet_bcxttDown;
  if(year==2016 or year==2018){
    zjet_bcxdyUp = DC.readWriteHisto(fDY, baseDir+"/bcxdyup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdyUp", true, true, zjet);
    zjet_bcxdyDown = DC.readWriteHisto(fDY, baseDir+"/bcxdydown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdyDown", true, true, zjet);
    zjet_bcxstUp = DC.readWriteHisto(fDY, baseDir+"/bcxstup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxstUp", true, true, zjet);
    zjet_bcxstDown = DC.readWriteHisto(fDY, baseDir+"/bcxstdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxstDown", true, true, zjet);
    zjet_bcxwjUp = DC.readWriteHisto(fDY, baseDir+"/bcxwjup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxwjUp", true, true, zjet);
    zjet_bcxwjDown = DC.readWriteHisto(fDY, baseDir+"/bcxwjdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxwjDown", true, true, zjet);
    zjet_bcxttUp = DC.readWriteHisto(fDY, baseDir+"/bcxttup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxttUp", true, true, zjet);
    zjet_bcxttDown = DC.readWriteHisto(fDY, baseDir+"/bcxttdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxttDown", true, true, zjet);
  }else{
    zjet_bcxdyUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdyUp", true);
    zjet_bcxdyDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdyDown", true);
    zjet_bcxstUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxstUp", true);
    zjet_bcxstDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxstDown", true);
    zjet_bcxwjUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxwjUp", true);
    zjet_bcxwjDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxwjDown", true);
    zjet_bcxttUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxttUp", true);
  ...
  if(year==2016){
    zjet_bcbfragUp = DC.readWriteHisto(fDY, baseDir+"/bcbfragup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcbfragUp", true, true, zjet);
    zjet_bcbfragDown = DC.readWriteHisto(fDY, baseDir+"/bcbfragdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcbfragDown", true, true, zjet);
  }else{
    zjet_bcbfragUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcbfragUp", true);
  ...
  if(year==2017){
    zjet_bcintpUp = DC.readWriteHisto(fDY, baseDir+"/bcintpup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcintpUp", true, true, zjet);
    zjet_bcintpDown = DC.readWriteHisto(fDY, baseDir+"/bcintpdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcintpDown", true, true, zjet);
    zjet_bcextpUp = DC.readWriteHisto(fDY, baseDir+"/bcextpup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcextpUp", true, true, zjet);
    zjet_bcextpDown = DC.readWriteHisto(fDY, baseDir+"/bcextpdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcextpDown", true, true, zjet);
    zjet_bcxdybUp = DC.readWriteHisto(fDY, baseDir+"/bcxdybup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdybUp", true, true, zjet);
    zjet_bcxdybDown = DC.readWriteHisto(fDY, baseDir+"/bcxdybdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdybDown", true, true, zjet);
    zjet_bcxdycUp = DC.readWriteHisto(fDY, baseDir+"/bcxdycup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdycUp", true, true, zjet);
    zjet_bcxdycDown = DC.readWriteHisto(fDY, baseDir+"/bcxdycdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxdycDown", true, true, zjet);
    zjet_bcxwjcUp = DC.readWriteHisto(fDY, baseDir+"/bcxwjcup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxwjcUp", true, true, zjet);
    zjet_bcxwjcDown = DC.readWriteHisto(fDY, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bcxwjcDown", true, true, zjet);
  }else{
    zjet_bcintpUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcintpUp", true);
    zjet_bcintpDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcintpDown", true);
    zjet_bcextpUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcextpUp", true);
    zjet_bcextpDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcextpDown", true);
    zjet_bcxdybUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdybUp", true);
    zjet_bcxdybDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdybDown", true);
    zjet_bcxdycUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdycUp", true);
    zjet_bcxdycDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxdycDown", true);
    zjet_bcxwjcUp = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxwjcUp", true);
    zjet_bcxwjcDown = DC.readWriteHisto(fDY, baseDir+"/base"+histSubDir, histName, sf_zjet, fout, fTT,  "zjet_bcxwjcDown", true);
  }
  ...
  TH1F* zjet_bclhemufUp = DC.readWriteHisto(fDY, baseDir+"/bclhemufup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bclhemufUp", true, true, zjet);
  TH1F* zjet_bclhemufDown = DC.readWriteHisto(fDY, baseDir+"/bclhemufdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bclhemufDown", true, true, zjet);
  TH1F* zjet_bclhemurUp = DC.readWriteHisto(fDY, baseDir+"/bclhemurup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bclhemurUp", true, true, zjet);
  TH1F* zjet_bclhemurDown = DC.readWriteHisto(fDY, baseDir+"/bclhemurdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_bclhemurDown", true, true, zjet);
  TH1F* zjet_isrUp = DC.readWriteHisto(fDY, baseDir+"/isrup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_isrUp", true, true, zjet);
  TH1F* zjet_isrDown = DC.readWriteHisto(fDY, baseDir+"/isrdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_isrDown", true, true, zjet);
  TH1F* zjet_fsrUp = DC.readWriteHisto(fDY, baseDir+"/fsrup"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_fsrUp", true, true, zjet);
  TH1F* zjet_fsrDown = DC.readWriteHisto(fDY, baseDir+"/fsrdown"+histSubDir, histName, sf_zjet, fout, fTT, "zjet_fsrDown", true, true, zjet);
  ...
  TH1F* stop_bcstatUp = DC.readWriteHisto(fST, baseDir+"/bcstatup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcstatUp", true, true, stop);
  TH1F* stop_bcstatDown = DC.readWriteHisto(fST, baseDir+"/bcstatdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcstatDown", true, true, stop);
  TH1F *stop_bcxdyUp, *stop_bcxdyDown, *stop_bcxstUp, *stop_bcxstDown, *stop_bcxwjUp, *stop_bcxwjDown, *stop_bcxttUp, *stop_bcxttDown;
  if(year==2016 or year==2018){
    stop_bcxdyUp = DC.readWriteHisto(fST, baseDir+"/bcxdyup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdyUp", true, true, stop);
    stop_bcxdyDown = DC.readWriteHisto(fST, baseDir+"/bcxdydown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdyDown", true, true, stop);
    stop_bcxstUp = DC.readWriteHisto(fST, baseDir+"/bcxstup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxstUp", true, true, stop);
    stop_bcxstDown = DC.readWriteHisto(fST, baseDir+"/bcxstdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxstDown", true, true, stop);
    stop_bcxwjUp = DC.readWriteHisto(fST, baseDir+"/bcxwjup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxwjUp", true, true, stop);
    stop_bcxwjDown = DC.readWriteHisto(fST, baseDir+"/bcxwjdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxwjDown", true, true, stop);
    stop_bcxttUp = DC.readWriteHisto(fST, baseDir+"/bcxttup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxttUp", true, true, stop);
    stop_bcxttDown = DC.readWriteHisto(fST, baseDir+"/bcxttdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxttDown", true, true, stop);
  }else{
    stop_bcxdyUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdyUp", true);
    stop_bcxdyDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdyDown", true);
    stop_bcxstUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxstUp", true);
    stop_bcxstDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxstDown", true);
    stop_bcxwjUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxwjUp", true);
    stop_bcxwjDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxwjDown", true);
    stop_bcxttUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxttUp", true);
  ...
  if(year==2016){
    stop_bcbfragUp = DC.readWriteHisto(fST, baseDir+"/bcbfragup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcbfragUp", true, true, stop);
    stop_bcbfragDown = DC.readWriteHisto(fST, baseDir+"/bcbfragdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcbfragDown", true, true, stop);
  }else{
    stop_bcbfragUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcbfragUp", true);
  ...
  if(year==2017){    
    stop_bcintpUp = DC.readWriteHisto(fST, baseDir+"/bcintpup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcintpUp", true, true, stop);
    stop_bcintpDown = DC.readWriteHisto(fST, baseDir+"/bcintpdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcintpDown", true, true, stop);
    stop_bcextpUp = DC.readWriteHisto(fST, baseDir+"/bcextpup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcextpUp", true, true, stop);
    stop_bcextpDown = DC.readWriteHisto(fST, baseDir+"/bcextpdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcextpDown", true, true, stop);
    stop_bcxdybUp = DC.readWriteHisto(fST, baseDir+"/bcxdybup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdybUp", true, true, stop);
    stop_bcxdybDown = DC.readWriteHisto(fST, baseDir+"/bcxdybdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdybDown", true, true, stop);
    stop_bcxdycUp = DC.readWriteHisto(fST, baseDir+"/bcxdycup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdycUp", true, true, stop);
    stop_bcxdycDown = DC.readWriteHisto(fST, baseDir+"/bcxdycdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxdycDown", true, true, stop);
    stop_bcxwjcUp = DC.readWriteHisto(fST, baseDir+"/bcxwjcup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxwjcUp", true, true, stop);
    stop_bcxwjcDown = DC.readWriteHisto(fST, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bcxwjcDown", true, true, stop);
  }else{
    stop_bcintpUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcintpUp", true);
    stop_bcintpDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcintpDown", true);
    stop_bcextpUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcextpUp", true);
    stop_bcextpDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcextpDown", true);
    stop_bcxdybUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdybUp", true);
    stop_bcxdybDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdybDown", true);
    stop_bcxdycUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdycUp", true);
    stop_bcxdycDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxdycDown", true);
    stop_bcxwjcUp = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxwjcUp", true);
    stop_bcxwjcDown = DC.readWriteHisto(fST, baseDir+"/base"+histSubDir, histName, sf_stop, fout, fTT,  "stop_bcxwjcDown", true);
  }
  ...
  TH1F* stop_bclhemufUp = DC.readWriteHisto(fST, baseDir+"/bclhemufup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bclhemufUp", true, true, stop);
  TH1F* stop_bclhemufDown = DC.readWriteHisto(fST, baseDir+"/bclhemufdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bclhemufDown", true, true, stop);
  TH1F* stop_bclhemurUp = DC.readWriteHisto(fST, baseDir+"/bclhemurup"+histSubDir, histName, sf_stop, fout, fTT, "stop_bclhemurUp", true, true, stop);
  TH1F* stop_bclhemurDown = DC.readWriteHisto(fST, baseDir+"/bclhemurdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_bclhemurDown", true, true, stop);
  TH1F* stop_isrUp = DC.readWriteHisto(fST, baseDir+"/isrup"+histSubDir, histName, sf_stop, fout, fTT, "stop_isrUp", true, true, stop);
  TH1F* stop_isrDown = DC.readWriteHisto(fST, baseDir+"/isrdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_isrDown", true, true, stop);
  TH1F* stop_fsrUp = DC.readWriteHisto(fST, baseDir+"/fsrup"+histSubDir, histName, sf_stop, fout, fTT, "stop_fsrUp", true, true, stop);
  TH1F* stop_fsrDown = DC.readWriteHisto(fST, baseDir+"/fsrdown"+histSubDir, histName, sf_stop, fout, fTT, "stop_fsrDown", true, true, stop);
  ...
  TH1F* vv_bcstatUp = DC.readWriteHisto(fVV, baseDir+"/bcstatup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcstatUp", true, true, vv);
  TH1F* vv_bcstatDown = DC.readWriteHisto(fVV, baseDir+"/bcstatdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcstatDown", true, true, vv);
  TH1F *vv_bcxdyUp, *vv_bcxdyDown, *vv_bcxstUp, *vv_bcxstDown, *vv_bcxwjUp, *vv_bcxwjDown, *vv_bcxttUp, *vv_bcxttDown;
  if(year==2016 or year==2018){
    vv_bcxdyUp = DC.readWriteHisto(fVV, baseDir+"/bcxdyup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdyUp", true, true, vv);
    vv_bcxdyDown = DC.readWriteHisto(fVV, baseDir+"/bcxdydown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdyDown", true, true, vv);
    vv_bcxstUp = DC.readWriteHisto(fVV, baseDir+"/bcxstup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxstUp", true, true, vv);
    vv_bcxstDown = DC.readWriteHisto(fVV, baseDir+"/bcxstdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxstDown", true, true, vv);
    vv_bcxwjUp = DC.readWriteHisto(fVV, baseDir+"/bcxwjup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxwjUp", true, true, vv);
    vv_bcxwjDown = DC.readWriteHisto(fVV, baseDir+"/bcxwjdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxwjDown", true, true, vv);
    vv_bcxttUp = DC.readWriteHisto(fVV, baseDir+"/bcxttup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxttUp", true, true, vv);
    vv_bcxttDown = DC.readWriteHisto(fVV, baseDir+"/bcxttdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxttDown", true, true, vv);
  }else{
    vv_bcxdyUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdyUp", true);
    vv_bcxdyDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdyDown", true);
    vv_bcxstUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxstUp", true);
    vv_bcxstDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxstDown", true);
    vv_bcxwjUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxwjUp", true);
    vv_bcxwjDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxwjDown", true);
    vv_bcxttUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxttUp", true);
  ...
  if(year==2016){
    vv_bcbfragUp = DC.readWriteHisto(fVV, baseDir+"/bcbfragup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcbfragUp", true, true, vv);
    vv_bcbfragDown = DC.readWriteHisto(fVV, baseDir+"/bcbfragdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcbfragDown", true, true, vv);
  }else{
    vv_bcbfragUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcbfragUp", true);
  ...
  if(year==2017){
    vv_bcintpUp = DC.readWriteHisto(fVV, baseDir+"/bcintpup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcintpUp", true, true, vv);
    vv_bcintpDown = DC.readWriteHisto(fVV, baseDir+"/bcintpdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcintpDown", true, true, vv);
    vv_bcextpUp = DC.readWriteHisto(fVV, baseDir+"/bcextpup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcextpUp", true, true, vv);
    vv_bcextpDown = DC.readWriteHisto(fVV, baseDir+"/bcextpdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcextpDown", true, true, vv);
    vv_bcxdybUp = DC.readWriteHisto(fVV, baseDir+"/bcxdybup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdybUp", true, true, vv);
    vv_bcxdybDown = DC.readWriteHisto(fVV, baseDir+"/bcxdybdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdybDown", true, true, vv);
    vv_bcxdycUp = DC.readWriteHisto(fVV, baseDir+"/bcxdycup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdycUp", true, true, vv);
    vv_bcxdycDown = DC.readWriteHisto(fVV, baseDir+"/bcxdycdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxdycDown", true, true, vv);
    vv_bcxwjcUp = DC.readWriteHisto(fVV, baseDir+"/bcxwjcup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxwjcUp", true, true, vv);
    vv_bcxwjcDown = DC.readWriteHisto(fVV, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bcxwjcDown", true, true, vv);
  }else{
    vv_bcintpUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcintpUp", true);
    vv_bcintpDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcintpDown", true);
    vv_bcextpUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcextpUp", true);
    vv_bcextpDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcextpDown", true);
    vv_bcxdybUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdybUp", true);
    vv_bcxdybDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdybDown", true);
    vv_bcxdycUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdycUp", true);
    vv_bcxdycDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxdycDown", true);
    vv_bcxwjcUp = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxwjcUp", true);
    vv_bcxwjcDown = DC.readWriteHisto(fVV, baseDir+"/base"+histSubDir, histName, sf_vv, fout, fTT,  "vv_bcxwjcDown", true);
  }
  ...
  TH1F* vv_bclhemufUp = DC.readWriteHisto(fVV, baseDir+"/bclhemufup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bclhemufUp", true, true, vv);
  TH1F* vv_bclhemufDown = DC.readWriteHisto(fVV, baseDir+"/bclhemufdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bclhemufDown", true, true, vv);
  TH1F* vv_bclhemurUp = DC.readWriteHisto(fVV, baseDir+"/bclhemurup"+histSubDir, histName, sf_vv, fout, fTT, "vv_bclhemurUp", true, true, vv);
  TH1F* vv_bclhemurDown = DC.readWriteHisto(fVV, baseDir+"/bclhemurdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_bclhemurDown", true, true, vv);
  TH1F* vv_isrUp = DC.readWriteHisto(fVV, baseDir+"/isrup"+histSubDir, histName, sf_vv, fout, fTT, "vv_isrUp", true, true, vv);
  TH1F* vv_isrDown = DC.readWriteHisto(fVV, baseDir+"/isrdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_isrDown", true, true, vv);
  TH1F* vv_fsrUp = DC.readWriteHisto(fVV, baseDir+"/fsrup"+histSubDir, histName, sf_vv, fout, fTT, "vv_fsrUp", true, true, vv);
  TH1F* vv_fsrDown = DC.readWriteHisto(fVV, baseDir+"/fsrdown"+histSubDir, histName, sf_vv, fout, fTT, "vv_fsrDown", true, true, vv);
  ...
  */
  ...
  TH1F* wh_bcstatUp = DC.readWriteHisto(fWH, baseDir+"/bcstatup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcstatUp", true, true, wh);
  TH1F* wh_bcstatDown = DC.readWriteHisto(fWH, baseDir+"/bcstatdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcstatDown", true, true, wh);
  TH1F *wh_bcxdyUp, *wh_bcxdyDown, *wh_bcxstUp, *wh_bcxstDown, *wh_bcxwjUp, *wh_bcxwjDown, *wh_bcxttUp, *wh_bcxttDown;
  if(year==2016 or year==2018){
     wh_bcxdyUp = DC.readWriteHisto(fWH, baseDir+"/bcxdyup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdyUp", true, true, wh);
     wh_bcxdyDown = DC.readWriteHisto(fWH, baseDir+"/bcxdydown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdyDown", true, true, wh);
     wh_bcxstUp = DC.readWriteHisto(fWH, baseDir+"/bcxstup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxstUp", true, true, wh);
     wh_bcxstDown = DC.readWriteHisto(fWH, baseDir+"/bcxstdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxstDown", true, true, wh);
     wh_bcxwjUp = DC.readWriteHisto(fWH, baseDir+"/bcxwjup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxwjUp", true, true, wh);
     wh_bcxwjDown = DC.readWriteHisto(fWH, baseDir+"/bcxwjdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxwjDown", true, true, wh);
     wh_bcxttUp = DC.readWriteHisto(fWH, baseDir+"/bcxttup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxttUp", true, true, wh);
     wh_bcxttDown = DC.readWriteHisto(fWH, baseDir+"/bcxttdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxttDown", true, true, wh);
  }else{
    wh_bcxdyUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdyUp", true);
    wh_bcxdyDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdyDown", true);
    wh_bcxstUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxstUp", true);
    wh_bcxstDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxstDown", true);
    wh_bcxwjUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxwjUp", true);
    wh_bcxwjDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxwjDown", true);
    wh_bcxttUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxttUp", true);
  ...
  if(year==2016){
     wh_bcbfragUp = DC.readWriteHisto(fWH, baseDir+"/bcbfragup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcbfragUp", true, true, wh);
     wh_bcbfragDown = DC.readWriteHisto(fWH, baseDir+"/bcbfragdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcbfragDown", true, true, wh);
  }else{
    wh_bcbfragUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcbfragUp", true);
  ...
  if(year==2017){
     wh_bcintpUp = DC.readWriteHisto(fWH, baseDir+"/bcintpup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcintpUp", true, true, wh);
     wh_bcintpDown = DC.readWriteHisto(fWH, baseDir+"/bcintpdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcintpDown", true, true, wh);
     wh_bcextpUp = DC.readWriteHisto(fWH, baseDir+"/bcextpup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcextpUp", true, true, wh);
     wh_bcextpDown = DC.readWriteHisto(fWH, baseDir+"/bcextpdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcextpDown", true, true, wh);
     wh_bcxdybUp = DC.readWriteHisto(fWH, baseDir+"/bcxdybup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdybUp", true, true, wh);
     wh_bcxdybDown = DC.readWriteHisto(fWH, baseDir+"/bcxdybdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdybDown", true, true, wh);
     wh_bcxdycUp = DC.readWriteHisto(fWH, baseDir+"/bcxdycup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdycUp", true, true, wh);
     wh_bcxdycDown = DC.readWriteHisto(fWH, baseDir+"/bcxdycdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxdycDown", true, true, wh);
     wh_bcxwjcUp = DC.readWriteHisto(fWH, baseDir+"/bcxwjcup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxwjcUp", true, true, wh);
     wh_bcxwjcDown = DC.readWriteHisto(fWH, baseDir+"/bcxwjcdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bcxwjcDown", true, true, wh);
  }else{
    wh_bcintpUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcintpUp", true);
    wh_bcintpDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcintpDown", true);
    wh_bcextpUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcextpUp", true);
    wh_bcextpDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcextpDown", true);
    wh_bcxdybUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdybUp", true);
    wh_bcxdybDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdybDown", true);
    wh_bcxdycUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdycUp", true);
    wh_bcxdycDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxdycDown", true);
    wh_bcxwjcUp = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxwjcUp", true);
    wh_bcxwjcDown = DC.readWriteHisto(fWH, baseDir+"/base"+histSubDir, histName, sf_wh, fout, fTT,  label+"_bcxwjcDown", true);
  }
  ...
  TH1F* wh_bclhemufUp = DC.readWriteHisto(fWH, baseDir+"/bclhemufup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bclhemufUp", true, true, wh);
  TH1F* wh_bclhemufDown = DC.readWriteHisto(fWH, baseDir+"/bclhemufdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bclhemufDown", true, true, wh);
  TH1F* wh_bclhemurUp = DC.readWriteHisto(fWH, baseDir+"/bclhemurup"+histSubDir, histName, sf_wh, fout, fTT, label+"_bclhemurUp", true, true, wh);
  TH1F* wh_bclhemurDown = DC.readWriteHisto(fWH, baseDir+"/bclhemurdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_bclhemurDown", true, true, wh);
  TH1F* wh_isrUp = DC.readWriteHisto(fWH, baseDir+"/isrup"+histSubDir, histName, sf_wh, fout, fTT, label+"_isrUp", true, true, wh);
  TH1F* wh_isrDown = DC.readWriteHisto(fWH, baseDir+"/isrdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_isrDown", true, true, wh);
  TH1F* wh_fsrUp = DC.readWriteHisto(fWH, baseDir+"/fsrup"+histSubDir, histName, sf_wh, fout, fTT, label+"_fsrUp", true, true, wh);
  TH1F* wh_fsrDown = DC.readWriteHisto(fWH, baseDir+"/fsrdown"+histSubDir, histName, sf_wh, fout, fTT, label+"_fsrDown", true, true, wh);
