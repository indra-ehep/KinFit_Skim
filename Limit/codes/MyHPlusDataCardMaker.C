...
void MyHPlusDataCardMakerNano(TString inFileDir="stack_20180418_Mu_Sys_PreAppComent",
  ...
  double sf_ttbar_scaleUp = 1; 
  TH1F* ttbar_scaleUp = DC.readWriteHisto(fTT, baseDir+"/cp5up"+histSubDir, histName, sf_ttbar_scaleUp, fout, fTT, "ttbar_scaleRF_ttUp", true);
  double sf_ttbar_scaleDown = 1; 
  TH1F* ttbar_scaleDown = DC.readWriteHisto(fTT, baseDir+"/cp5down"+histSubDir, histName, sf_ttbar_scaleDown, fout, fTT, "ttbar_scaleRF_ttDown", true);
  double sf_ttbar_mtop1715 = 1; 
  ...
  */
  ...
  while (in.good()){
	...
	// cout <<  "===== Hello There 6 ===== " << endl;
	  ...
	  << space << stop->Integral()
	   << space << vv->Integral()
            << space << qcd_dd->Integral()
            << endl;
	// cout <<  "===== Hello There 7 ===== " << endl;
      }
      else if(line.find("CMS_eff_lep")!=string::npos){  
        if(isMuChannel) line.replace( line.find("lep") , 4 , string(Form("%s", "m")));   
        else line.replace( line.find("lep") , 4 , string(Form("%s", "e")));
        out << line << endl;
	// cout <<  "===== Hello There 8 ===== " << endl;
      }  
      else if(line.find("CMS_eff_bcInc1")!=string::npos){
        // float bTagUnc_wh = (wh->Integral() > 0) ? DC.getBTagUnc(wh, wh_bcTag1Up, wh_bcTag1Down) : 1.00;
        // line.replace( line.find("HHHH") , 4 , string(Form("%.3f", bTagUnc_wh)) );
	...
	// cout <<  "===== Hello There 14 ===== " << endl;
      ...
      // 	line.replace( line.find("TTTT") , 4 , string(Form("%.3f", scaleUnc_ttbar)) ); 
      // 	out << line << endl;
      // 	// cout <<  "===== Hello There 15 ===== " << endl;
      // }
      // else if(line.find("hDamp_tt")!=string::npos){
      //   float matchUnc_ttbar = (ttbar->Integral() > 0) ? DC.getBTagUnc(ttbar, ttbar_matchingUp, ttbar_matchingDown) : 1.00; 
      //   line.replace( line.find("TTTT") , 4 , string(Form("%.3f", matchUnc_ttbar)) ); 
      //   out << line << endl;
      // 	// cout <<  "===== Hello There 16 ===== " << endl;
      // }
      // else if(line.find("topMass_tt")!=string::npos){
      // 	float mtopUnc_ttbar = (ttbar->Integral() > 0) ? DC.getBTagUnc(ttbar, ttbar_mtop1735, ttbar_mtop1715) : 1.00; 
      // 	line.replace( line.find("TTTT") , 4 , string(Form("%.3f", mtopUnc_ttbar)) ); 
      // 	out << line << endl;
      // 	// cout <<  "===== Hello There 17 ===== " << endl;
      // }
      // else if(line.find("CMS_bcxtt")!=string::npos and (year==2016 or year==2018)){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxwj")!=string::npos and (year==2016 or year==2018)){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxst")!=string::npos and (year==2016 or year==2018)){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxdy")!=string::npos and (year==2016 or year==2018)){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxdyb")!=string::npos and year==2017){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxdyc")!=string::npos and year==2017){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcxwjc")!=string::npos and year==2017){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcintp")!=string::npos and year==2017){
      ...
      //   out << line << endl;
      // }
      // else if(line.find("CMS_bcextp")!=string::npos and year==2017){
