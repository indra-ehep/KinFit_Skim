...
void CompareLimits(){
  ...
  leg->AddEntry(grlexclMini,"Published:Unblinded:Excl:Expected:MiniAOD #mu+jets, lnN, 2016","LP");
  leg->AddEntry(grlexclMiniInc,"Published:Unblinded:InclKF:Expected:MiniAOD #mu+jets, lnN, 2016","LP");
  // leg->AddEntry(grlexclMEqv16lnN, "Current:Blinded:BTagSyst:Expected:MiniAOD Equivalent #mu+jets, lnN, 2016","LP"); //01
  // leg->AddEntry(grlexclMEqv16shape, "Current:Blinded:BTagSyst:Expected:MiniAOD Equivalent #mu+jets, shape, 2016","LP");
  
  leg->AddEntry(grlexclMEqv16lnN, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, lnN, 2016","LP"); //01
  //leg->AddEntry(grlexclMEqv16shape, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, 2016","LP");
  leg->AddEntry(grlinclNanoUnNorm, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank1, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank13, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-3#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank134, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-4#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank1345, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-5#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank13456, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-6#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank134567, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-7#rightarrow lnN, 2016","LP");
  // leg->AddEntry(grlinclNanoUN_Rank1345678, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-8#rightarrow lnN, 2016","LP");
  // leg->AddEntry(grlinclNanoUN_Rank1t8_17, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-9#rightarrow lnN, 2016","LP");
  // leg->AddEntry(grlinclNanoUN_Rank1t8_17_21, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-10#rightarrow lnN, 2016","LP");
  //leg->AddEntry(grlinclNanoUN_Rank1t8_17_21_24, "Current:Blinded:InclKF:Expected:NanoAOD #mu+jets, shape, rank1-11#rightarrow lnN, 2016","LP");

  // leg->AddEntry(grlexclMEqv16lnN, "Current:Blinded:Excl:Expected:NanoAOD l+jets, shape, 2016","LP");
  // leg->AddEntry(grlexclMEqv16shape, "Current:Blinded:Excl:Expected:NanoAOD l+jets, shape, 2017","LP");
  // leg->AddEntry(grlexclNano16, "Current:Blinded:Excl:Expected:NanoAOD l+jets, shape, 2018","LP");
  // leg->AddEntry(grlexclNano, "Current:Blinded:Excl:Expected:NanoAOD l+jets, shape, Run2","LP");
