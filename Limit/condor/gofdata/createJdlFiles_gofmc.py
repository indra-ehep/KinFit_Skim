...
#for mass in [50,60,70,90,100,110,130,140,150,155]:
    ...
    for injpoint in injpointList:        
        ...
        run_command =  'Arguments  = %s 2016 mu_ele %s $(cluster)_$(process)\nQueue 1\n\n' %(mass, injpoint)
        jdlFile.write(run_command)        
        run_command =  'Arguments  = %s 2017 mu_ele %s $(cluster)_$(process)\nQueue 1\n\n' %(mass, injpoint)
        jdlFile.write(run_command)        
        run_command =  'Arguments  = %s 2018 mu_ele %s $(cluster)_$(process)\nQueue 1\n\n' %(mass, injpoint)
        jdlFile.write(run_command)        
    jdlFile.close()
