...
Bool_t KinAna::Process(Long64_t entry)
{
  ...
  // if(TMath::Abs(cjhadAF.E()-sjhadAF.E())/(cjhadAF+sjhadAF).P() >= 0.6)
  //   return true;
  
  Float_t pt_array[4] = {jetChadPt, jetShadPt, jetBhadPt, jetBlepPt};
  Float_t minPt = TMath::MinElement(4,pt_array);
  if(minPt<25.0)
    return true;
  //////////////////////////////////////////////
