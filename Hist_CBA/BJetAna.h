...
class BJetAna : public TSelector {
public :
  ...
  TLorentzVector cjhadBF, sjhadBF;
  ///////////////////////////////////////////////////////
  // Type of KF Event
  ///////////////////////////////////////////////////////
  Bool_t singleMu;
  ...
  bool    FillBTagCFBTHists(int isyst, double combined_muwt, double combined_muwt_nobtagwt, double combined_elewt, double combined_elewt_nobtagwt);
...
void BJetAna::Init(TTree *tree)
{
  ...
  tree->SetBranchStatus("metPt",1);		   tree->SetBranchAddress("metPt", &metPt);
  tree->SetBranchStatus("metPhi",1);		   tree->SetBranchAddress("metPhi", &metPhi);
  ...
  tree->SetBranchStatus("lepMass",1);		   tree->SetBranchAddress("lepMass", &lepMass);
  ...
  tree->SetBranchStatus("jetPt",1);		   tree->SetBranchAddress("jetPt", &_jetPt);
  tree->SetBranchStatus("jetEta",1);		   tree->SetBranchAddress("jetEta", &_jetEta);
  tree->SetBranchStatus("jetPhi",1);		   tree->SetBranchAddress("jetPhi", &_jetPhi);
  tree->SetBranchStatus("jetMass",1);		   tree->SetBranchAddress("jetMass", &_jetMass);
  tree->SetBranchStatus("jetDeepB",1);		   tree->SetBranchAddress("jetDeepB", &_jetDeepB);
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////
